...
classDiagram
    ...
    class IOrderCalculator {
        <<interface>>
        +calculateTotal(price: double, quantity: int) void
    }
    class OrderCalculator
    IOrderCalculator <|.. OrderCalculator : implements
    ...
    class OrderPlacer
    IOrderPlacer <|.. OrderPlacer : implements

    class IInvoiceGenerator {
        <<interface>>
        +generateInvoice(fileName: String) void
    }
    class InvoiceGenerator
    IInvoiceGenerator <|.. InvoiceGenerator : implements
    ...
    class EmailNotifier
    IEmailNotifier <|.. EmailNotifier : implements

    class OrderTest {
        +main(args: String[]) void
    }

    OrderTest ..> IOrderCalculator : uses
    OrderTest ..> IOrderPlacer : uses
    OrderTest ..> IInvoiceGenerator : uses
    OrderTest ..> IEmailNotifier : uses